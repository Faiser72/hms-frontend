...
@NgModule({
  declarations: [DepartmentComponent,LabtestmasterComponent,ReceiptcategoryComponent,PaymentcategoryComponent,AddhospitalDetailComponent,HospitalDetailHomeComponent,HospitalDetailListComponent,EditHospitalDetailComponent,AddStaffComponent,StaffListComponent,StaffHomeComponent,EditStaffComponent,DoctorrolemasterComponent],
  imports: [
    CommonModule,
    MatDividerModule,
    MatFormFieldModule,
